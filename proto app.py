...
def ventana_epipremnum():
    ...
    def info1():
        ...
        boton_cerrar = tk.Button(
			info_e,
			text = "Cerrar",
			command = lambda:[info_e.destroy(),epipremnum.destroy(),principal.destroy()],
			padx = 40,
			pady = 10)
        boton_cerrar.place(
			anchor = "s",
    ...
    def info3():
        ...
        info = tk.Label(
			info_e,
			text = "Este genero tan curioso de plantas, es perfecto para poder decorar\n"
    ...
    def info4():
        ...
        info = tk.Label(
			...
			"de esa manera,evita mantenerla a luz directa del sol ya que esto\n"
			"no le gusta, mantenla cerca de la ventana evitando lo anterior dicho",
			padx = 10,
			pady= 10
		)
        info.place(
...
def ventana_coryphanta():
    ...
    def info1():
        ...
        boton_cerrar = tk.Button(
			info_e,
			text = "Cerrar",
			command = lambda:[info_e.destroy(),coryphanta.destroy(),principal.destroy()],
			padx = 40,
			pady = 10)
        boton_cerrar.place(
			anchor = "s",
    ...
    def info4():
        ...
        info = tk.Label(
			...
			"hojas secas, corteza y turba, es lo mejor para su perfecto desarrollo",
			padx = 10,
			pady= 10
		)
        info.place(
