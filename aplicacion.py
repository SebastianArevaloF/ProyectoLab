...
# (a expandir si alcanza el tiempo) géneros específico de planta
...
# Alternativas
# Aquí van algunos strings que se repiten en los prints para no tener que
...
print("Hola!, esta app te podrá dar información sobre algunos generos "
      "de plantas , como sus cuidados, beneficios, etc.")
print("1)", EPI)
print("2)", CORY)

# PRIMER INPUT PARA SABER DE QUE GENERO DESEA RECIBIR INFORMACION EL USUARIO
planta_usuario = input("Por favor escriba el número de"
...
i = 0
# SE ESCRIBE UN CICLO WHILE QUE MANTENGA A TODO EL DESARROLLO,
# YA QUE ASI SI EL USUARIO QUIERE, PUEDE VOLVER A RESPONDER
# LA PREGUNTA SI QUIERE MAS INFORMACION
while i == 0:
...
# SE ESCRIBEN 2 CONDICIONALES PARA RESPONDER LAS PREGUNTAS SEGUN
# EL GENERO QUE ESCRIBIO EL USUARIO
    if planta_usuario in genero_e:
        if preguntas in PREGUNTA_1:
            print("La Epipremnum, tambien conocida como potos, perteneciente "
                  "a la familia Araceae, puede tener tallos de hasta "
                  "4cm de diámetro, esta no florece de manera natural, "
